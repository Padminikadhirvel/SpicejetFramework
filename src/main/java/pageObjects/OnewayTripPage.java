...
//	@FindBy(xpath="(//div[@class='css-76zvg2 r-homxoj r-ubezar r-16dba41'][contains(text(),'1')])[12]")
...
//	@FindBy(xpath="/html[1]/body[1]/div[2]/div[1]/div[1]/div[1]/div[5]/div[1]/div[1]/div[2]/div[2]")
	...
	@FindBy(xpath="//div[contains(text(),'Price Summary')]")
...
//		    .executeScript("return document.readyState")));
	...
	public void Onboarding(String Fromplace) {
		...
		wait.until(ExpectedConditions.visibilityOf(boardingFrom));
		boardingFrom.click();
...
//		flightcontinue.click();
	...
	public void enterpassenger2details(String p2fname, String p2lname, String p2mobno) {
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(40));
		wait.until(ExpectedConditions.visibilityOf(pas2title));
		pas2title.click();
	...
	public void enterpassenger3details(String p3fname, String p3lname) {
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(40));
		wait.until(ExpectedConditions.visibilityOf(pas3title));
		pas3title.click();
	...
	public void enterpassenger4details(String p4fname, String p4lname) {
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(40));
		wait.until(ExpectedConditions.visibilityOf(pas4title));
		pas4title.click();
